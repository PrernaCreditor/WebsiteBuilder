    ...
    return (
      ...
      >
        <div className="absolute inset-0 z-0">
          ...
          <iframe
            src={`${content.videoUrl}?autoplay=1&mute=1&loop=1&controls=0&playlist=${content.videoUrl
              ?.split('/')
              .pop()}`}
        ...
        <div className="container mx-auto px-6 relative z-10 flex flex-col items-center justify-center min-h-[70vh] text-center">
          <div className="max-w-4xl space-y-8 animate-fade-in">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <button className="group px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 flex items-center gap-2 bg-white/20 backdrop-blur-sm border border-white/30 text-white">
                <span
                  contentEditable={isEditing}
                  suppressContentEditableWarning
                  onBlur={(e) => handleTextEdit('ctaText', e)}
              ...
              <button className="group px-8 py-4 rounded-full font-semibold text-lg border-2 transition-all duration-300 hover:bg-white hover:text-black flex items-center gap-2 text-white">
                <Play className="w-5 h-5" />
                <span
                  contentEditable={isEditing}
                  suppressContentEditableWarning
        ...
        <div className="container mx-auto px-6 py-20">
          <div className="max-w-3xl space-y-6">
            ...
            <div className="flex flex-wrap gap-3 pt-4">
              <button className="px-6 py-3 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 flex items-center gap-2 bg-blue-500 text-white">
                <span
                  contentEditable={isEditing}
                  suppressContentEditableWarning
                  onBlur={(e) => handleTextEdit('ctaText', e)}
              ...
              <button className="px-6 py-3 rounded-lg font-medium transition-all duration-300 hover:bg-white/10 text-white">
                <span
                  contentEditable={isEditing}
                  suppressContentEditableWarning
                  onBlur={(e) => handleTextEdit('ctaSecondaryText', e)}
      ...
      >
        ...
        <div className="container mx-auto px-6 relative z-10 flex flex-col items-center justify-center min-h-[80vh] text-center">
          <div className="max-w-5xl space-y-8 animate-fade-in">
            ...
            <p
              className="text-xl md:text-2xl opacity-80 max-w-2xl mx-auto text-slate-200"
              contentEditable={isEditing}
              suppressContentEditableWarning
              onBlur={(e) => handleTextEdit('subheadline', e)}
            >
            ...
            <div className="flex flex-wrap justify-center gap-4 pt-4">
              <button className="group px-10 py-5 rounded-2xl font-bold text-xl transition-all duration-300 transform hover:scale-105 flex items-center gap-3 bg-white text-gray-900 shadow-2xl">
                <span
                  contentEditable={isEditing}
                  suppressContentEditableWarning
                  onBlur={(e) => handleTextEdit('ctaText', e)}
              ...
              <button className="group px-10 py-5 rounded-2xl font-bold text-xl border-2 border-white/20 transition-all duration-300 hover:bg-white/10 flex items-center gap-3 backdrop-blur-sm text-white">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[70vh]">
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex flex-wrap gap-4">
              <button className="group px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-glow flex items-center gap-2 bg-gradient-to-br from-blue-500 to-purple-500 text-white">
                <span
                  contentEditable={isEditing}
                  suppressContentEditableWarning
                  onBlur={(e) => handleTextEdit('ctaText', e)}
              ...
              <button className="group px-8 py-4 rounded-xl font-semibold text-lg border-2 transition-all duration-300 hover:bg-white/10 flex items-center gap-2 text-white border-white/30">
                <Play className="w-5 h-5" />
                <span
                  contentEditable={isEditing}
                  suppressContentEditableWarning
